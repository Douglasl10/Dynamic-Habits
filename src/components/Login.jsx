...
export default function Login() {
    ...
    const hanleEmail = async () => {
        ...
        if(error) {
            ...
            setMessage({type: 'success', text: 'Confirme seu email para continuar'})
        }
    }
        ...
        <div className="min-h-screen bg-[#080808] flex items-center justify-center p-4">
            <div className="w-full max-w-sm">
                ...
                <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-2xl p-6">
                    ...
                    {message && (
                        <div className={`text-xs font-mono px-3 py-2 rounded-lg mb-4 ${
                            message.type === 'error' ? "bg-red-500/10 text-red-400 border border-red-500/10"
                    ...
                    <button
                    onClick={() => {setIsSignUp(o => !o); setMessage(null)}}
