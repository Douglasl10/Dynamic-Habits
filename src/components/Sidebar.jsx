  ...
  return (
    <aside className="w-56 h-full min-h-screen bg-[#090909] border-r border-[#141414] flex flex-col py-6 overflow-y-auto">
      ...
      <div className="px-5 pb-5 border-b border-[#141414] mb-5 flex items-center justify-between">
        <div>
          <span className="font-['Bebas_Neue'] text-3xl text-white tracking-widest">HABIT</span>
          <span
      ...
      <div className="flex flex-col gap-1.5 px-3 flex-1 overflow-y-auto">
        <p className="text-[10px] text-[#252525] tracking-[0.2em] font-mono px-1 mb-2">CATEGORIAS</p>
        {TOPICS.map(t => {
          const done  = habits.filter(h => h.topic === t.id && h.completedDates.includes(todayStr)).length
